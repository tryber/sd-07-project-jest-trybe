...
describe('verifica o usuário', () => {
  ...
  result.name.first = 'Antônio'
  result.name.last = 'Britto'
  result.location = new Object
  result.location.country = 'Brazil'
  result.email = 'tunico@bol.com.br'
  result.login = new Object
  result.login.username = 'tunicao123'
  result.login.password = '1234567890'
  apiURL.mockResolvedValue(result)
