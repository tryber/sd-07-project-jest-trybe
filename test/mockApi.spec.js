...
No entanto, nos testes abaixo, queremos que todas as vezes que chamarmos a API
a resposta contenha as informações do nosso adminis..Cof! Cof!..
programador favorito, Tunicão.
...
describe('verifica o usuário', () => {
  api.fetchURL = jest.fn().mockImplementation(() => Promise.resolve({
    gender: 'male',
    name: {
      title: 'Ms',
      first: 'Antônio',
    ...
    dob: {
      date: '1965-10-01T06:35:49.694Z',
      age: 55,
      },
    registered: {
      date: '2009-02-11T05:48:39.772Z',
      age: 11,
    },
    phone: '021-953-7205',
    cell: '081-160-6277',
